...
{
	QUERY_END_TIMEOUTS = 100,
	ALLOCATION_TIMEOUTS = 100,
	SET_END_STATUS_TIMEOUTS = 100,
	REALLOCATION_TIMEOUTS = 100,
	KEYPAD_ACTION_TIMEOUTS = 100,
	SET_ENDLIGHT_TIMEOUTS = 100,
	NEW_ALLOCATION_TIMEOUTS = 100,
	END_ASSIGN_TIMEOUTS = 100,
	SET_END_LCD_TIMEOUTS  = 100,
	COMMON_SEND_END_LCD_TIMEOUTS = 100,
	SET_END_LED_TIMEOUTS = 100,
	COMMON_SEND_END_LED_TIMEOUTS = 100,
	PRESIDENT_CONTROL_TIMEOUTS =  100,
	SEND_VOTE_RESULT_TIMEOUTS = 100,
	TALKTIME_LEN_TIMEOUTS = 100,	
	HOST_SEND_STATUS_TIMEOUTS = 100,	
	SEND_END_LCD_DISPLAY_TIMEOUTS = 100,
	OPTITION_END_TIMEOUTS = 100,
	SET_MIS_STATUS_TIMEOUTS = 100,
	END_SPETHING_TIMEOUTS = 100,
	CHECK_END_RESULT_TIMEOUTS = 100,
	TRANSIT_HOST_MSG_TIMEOUTS = 100,
	TRANSIT_END_MSG_TIMEOUTS = 100,
};

enum udp_upper_cmd_timeout //  upper and host deal timouts
{
	CONFERENCE_DISCUSSION_PARAMETER_TIMEOUTS = 100,
	MISCROPHONE_SWITCH_TIMEOUTS = 100,
	MISCROPHONE_STATUS_TIMEOUTS = 100,
	SELECT_PROPOSER_TIMEOUTS = 100,
	EXAMINE_APPLICATION_TIMEOUTS = 100, 
	CONFERENCE_PERMISSION_TIMEOUTS = 100,
	SENDDOWN_MESSAGE_TIMEOUTS = 100,
	BEGIN_SIGN_TIMEOUTS = 100, 
	SIGN_SITUATION_TIMEOUTS = 100,
	END_OF_SIGN_TIMEOUTS = 100,
	ENDSTATION_ALLOCATION_APPLICATION_ADDRESS_TIMEOUTS = 100,
	ENDSTATION_REGISTER_STATUS_TIMEOUTS = 100, 
	CURRENT_VIDICON_TIMEOUTS = 100,
	ENDSTATION_ADDRESS_UNDETERMINED_ALLOCATION_TIMEOUTS = 100,
	VIDICON_CONTROL_TIMEOUTS = 100,
	VIDICON_PRERATION_SET_TIMEOUTS = 100,
	VIDICON_LOCK_TIMEOUTS = 100,
	VIDICON_OUTPUT_TIMEOUTS = 100,
	BEGIN_VOTE_TIMEOUTS = 100,
	PAUSE_VOTE_TIMEOUTS = 100,
	REGAIN_VOTE_TIMEOUTS = 100, 
	END_VOTE_TIMEOUTS = 100,
	RESULT_VOTE_TIMEOUTS = 100,
	TRANSMIT_TO_ENDSTATION_TIMEOUTS = 100,
	REPORT_ENDSTATION_MESSAGE_TIMEOUTS = 100,
	HIGH_DEFINITION_SWITCH_SET_TIMEOUTS = 100, 
};
