...
struct response_data_interval_util response_data_interval_util_tables[] = 
{
	...
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_STOP, CAMERA_CTRL_STOP_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_AUTO_SCAN, CAMERA_CTRL_AUTO_SCAN_INTERVAL_TIME  },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_IRIS_CLOSE, CAMERA_CTRL_IRIS_CLOSE_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_IRIS_OPEN, CAMERA_CTRL_IRIS_OPEN_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_FOCUCS_NEAR, CAMERA_CTRL_FOCUCS_NEAR_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_FOCUCS_FAR, CAMERA_CTRL_FOCUCS_FAR_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_ZOOM_WIDE, CAMERA_CTRL_ZOOM_WIDE_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_ZOOM_TELE, CAMERA_CTRL_ZOOM_TELE_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_DOWN, CAMERA_CTRL_DOWN_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_UP, CAMERA_CTRL_UP_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_LEFT, CAMERA_CTRL_LEFT_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_RIGHT, CAMERA_CTRL_RIGHT_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_PRESET_SET, CAMERA_CTRL_PRESET_SET_INTERVAL_TIME },
	{ TRANSMIT_TYPE_UART_CTRL, CAMERA_CTRL_PRESET_CALL, CAMERA_CTRL_PRESET_CALL_INTERVAL_TIME },
