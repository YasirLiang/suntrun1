...
const func_link_items func_link_tables[MAX_FUNC_LINK_ITEMS] =
{
	...
	{ MENUMENT_USE, MENU_AUTO_CLOSE_CMD, FUNC_MENU_AUTO_CLOSE_CMD, 0},
	{ MENUMENT_USE, MENU_DISC_MODE_SET_CMD, FUNC_MENU_DISC_MODE_SET_CMD, 0},
	{ MENUMENT_USE, MENU_SPK_LIMIT_NUM_SET, FUNC_MENU_SPK_LIMIT_NUM_SET, 0},
	{ MENUMENT_USE, MUNU_APPLY_LIMIT_NUM_SET, FUNC_MUNU_APPLY_LIMIT_NUM_SET, 0},
	
	{ MENUMENT_USE, MENU_MUSIC_EN_SET, FUNC_MENU_MUSIC_EN_SET, 0},
	{ MENUMENT_USE, MENU_CMR_SAVE_PRESET, FUNC_MENU_CMR_SAVE_PRESET, 0},
	{ MENUMENT_USE, MENU_CMR_SEL_CMR, FUNC_MENU_CMR_SEL_CMR, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_LR, FUNC_MENU_CMR_CTRL_LR, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_UD, FUNC_MENU_CMR_CTRL_UD, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_FOUCE, FUNC_MENU_CMR_CTRL_FOUCE, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_ZOOM, FUNC_MENU_CMR_CTRL_ZOOM, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_APERT, FUNC_MENU_CMR_CTRL_APERT, 0},
	{ MENUMENT_USE, MENU_CMR_CTRL_ALIGN, FUNC_MENU_CMR_CTRL_ALIGN, 0},
	{ MENUMENT_USE, MENU_CMR_FULL_VIEW, FUNC_MENU_CMR_FULL_VIEW, 0},
	{ MENUMENT_USE, MENU_CMR_CLR_PRESET, FUNC_MENU_CMR_CLR_PRESET, 0},
	{ MENUMENT_USE, MENU_PRIOR_EN_SET, FUNC_MENU_PRIOR_EN_SET, 0},
	{ MENUMENT_USE, MENU_TERMINAL_SYS_REGISTER, FUNC_MENU_TERMINAL_SYS_REGISTER },// 2016/1/23 add
	{ MENUMENT_USE, MENU_TEMP_CLOSE_SET, FUNC_MENU_TEMP_CLOSE_SET }, // 2016/3/18 ADD
	{ MENUMENT_USE, MENU_CMR_TRACK, FUNC_MENU_CMR_TRACK }, // 2016/3/18 ADD
