...
enum udp_upper_cmds_values/// The command codes values for confernce commands
{
	CONFERENCE_DISCUSSION_PARAMETER = 0x1,
	MISCROPHONE_SWITCH = 0x2,
...
{
	CONFERENCE_DISCUSSION_PARAMETER_TIMEOUTS = 500,
	MISCROPHONE_SWITCH_TIMEOUTS = 500,
	MISCROPHONE_STATUS_TIMEOUTS =500,
	SELECT_PROPOSER_TIMEOUTS = 500,
	EXAMINE_APPLICATION_TIMEOUTS = 500, 
	CONFERENCE_PERMISSION_TIMEOUTS =500,
	SENDDOWN_MESSAGE_TIMEOUTS = 500,
	BEGIN_SIGN_TIMEOUTS = 500, 
	SIGN_SITUATION_TIMEOUTS = 500,
	END_OF_SIGN_TIMEOUTS = 500,
	ENDSTATION_ALLOCATION_APPLICATION_ADDRESS_TIMEOUTS = 500,
	ENDSTATION_REGISTER_STATUS_TIMEOUTS = 500, 
	CURRENT_VIDICON_TIMEOUTS = 500,
	ENDSTATION_ADDRESS_UNDETERMINED_ALLOCATION_TIMEOUTS = 500,
	VIDICON_CONTROL_TIMEOUTS = 500,
	VIDICON_PRERATION_SET_TIMEOUTS = 500,
	VIDICON_LOCK_TIMEOUTS = 500,
	VIDICON_OUTPUT_TIMEOUTS = 500,
	BEGIN_VOTE_TIMEOUTS = 500,
	PAUSE_VOTE_TIMEOUTS = 500,
	REGAIN_VOTE_TIMEOUTS = 500, 
	END_VOTE_TIMEOUTS = 500,
	RESULT_VOTE_TIMEOUTS = 500,
	TRANSMIT_TO_ENDSTATION_TIMEOUTS = 500,
	REPORT_ENDSTATION_MESSAGE_TIMEOUTS = 500,
	HIGH_DEFINITION_SWITCH_SET_TIMEOUTS = 500, 
};
